              ...
              >
                ...
                <div class="abNormal">
                  <Table
                    ...
                    :current="current"
                    :is-current-selected-leaf="isCurrentSelectedLeaf"
...
export default {
  ...
  data() {
    return {
      ...
      formValues: {},
      treeData: [],
      isCurrentSelectedLeaf: false
    }
  },
  computed: {
    canEdit() {
      if ((this.thirdLevel === 'ZZLL_BD_ZBDTQK' || this.thirdLevel === 'ZZLL_BD_RYDTQK') && !this.isCurrentSelectedLeaf) {
        return false
      }
      return true
    }
  ...
  methods: {
    ...
    onHandleClickBdTreeNode(data) {
      this.isCurrentSelectedLeaf = !data.childList || (data.childList && data.childList.length === 0)
      this.forceCode = data.field
