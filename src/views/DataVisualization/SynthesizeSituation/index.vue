<template>
  ...
  <div v-loading="loading2"
    ...
    <el-button ref="mapB" class="changeMap" @click="changeMap">切换3D</el-button>

    <MapOl ref="MapOl" :tools="mapTools" :imgPath="imgPath" :mouseClicks="mouseClicks" :is-add-popup="true" v-model="firstMap" @featureMarkerLayer="featureMarkerLayer" @searchByRange="searchByRange" @signs="signs"/>

    <Cesium ref="Cesium" />

    <div id="distance" class="distance-container" />
    <el-button class="junbiao" @click="sign" ref="jbContainer">军标</el-button>
    ...
    <div class="left" ref="leftContainer">
      ...
      <div style="width: 285px;height:500px;overflow-y:auto;scrollbar-width:thin;">
        ...
        <el-collapse-item style="padding:5px;background:white;padding-bottom:0px;">
            ...
            <el-popover
              ...
              <el-form ref="form" :model="formDetails" label-width="80px">
                ...
                <div style="display:flex;justify-content: flex-end;">
                  ...
                  <!--
                    <el-button type="primary" size="mini" style="" @click="getForceData">确定</el-button>
                  -->
                  
                </div>
              </el-form>
              
              <i class="header-icon el-icon-tickets"  slot="reference" style="margin-left:180px;"></i>
            </el-popover>
          </template>
          <div>
            <el-checkbox-group
          ...
          <el-button type="primary" size="mini" style="margin-left:200px;" @click="getForceData">查询</el-button>
        ...
        <el-collapse-item style="padding:5px;background:white;padding-bottom:0px;">
            ...
            <el-popover
              ...
              <el-form ref="form" :model="formCombatData" label-width="80px">
                ...
                <div style="display:flex;justify-content: flex-end;">
                  ...
                  <!--
                    <el-button type="primary" size="mini" style="" @click="getWarEngineerings">确定</el-button>
                  -->
                </div>
          ...
          >
            ...
            <el-button type="primary" size="mini" style="margin-left:200px;" @click="getWarEngineerings">查询</el-button>
        </el-collapse-item>
        ...
        <el-collapse-item style="padding:5px;background:white;padding-bottom:0px;">
          ...
          <el-button type="primary" size="mini" style="margin-left:200px;" @click="zchjClick">查询</el-button>
        </el-collapse-item>
        ...
        <el-collapse-item style="padding:5px;background:white;padding-bottom:0px;">
          ...
          <el-button type="primary" size="mini" style="margin-left:200px;" @click="hqbzClick">查询</el-button>
        </el-collapse-item>
        </el-collapse-item>
          ...
          -->
          <br/>
          <div v-if="radioTime==='实时'" style="margin-top:10px;display:inline-block;margin-left:10px;" v-for="(item, index) in checkNowEng" :key="item.NM">
    ...
    <div class="table" v-if="radioTime==='历史'">
      <div class="tableTop">
        ...
        <el-checkbox class="WZcheck" v-model="wzChecked">伪装</el-checkbox>
        <i
    ...
    <el-dialog
      ...
      <!-- 战备工程基本信息 -->
      <div class="box-show" v-if='pointTypes === "2" && pointTypes !== ""'>
        ...
        <div v-if="kzxxData.length!='0'">
          ...
          <div class="bottom" v-if="kzxxData && kzxxData.length > 0">
            <p v-for="(item,index) in kzxxData" :key="index" :title="item.value" style="display:inline-block;width:24%;margin-right: 30px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">{{item.key}}: {{item.value}}</p>
          </div>
          <el-divider />
        </div>
        <!-- 所在防护责任区 -->
      ...
      <!-- 作战力量信息-->
      <div class="box-show" v-if='pointTypes === "1"'>
        <span style="display:inline-block;width:5px;height:15px;background:blue;margin-right:5px;"></span>
        <span
          class="top"
          style="display:inline-block;font-weight: bold; font-size: 14px;"
        ...
        <div>
          ...
          >
           ...
           <div class="bottom" style="padding-bottom:15px;padding-top:10px;" v-for="item in zzllDetailsDFRW" :key="item.BDNM_KEY">{{ item.DFRW? item.DFRW : "暂无" }}</div>
        ...
        <div>
          ...
          >
           ...
           <div class="bottom">
            <el-carousel height="250px" style="width:60%;margin:auto" v-if="zzllMTXX && zzllMTXX.length > 0">
      ...
      <!-- 后勤保障 -->
      <div class="box-show" v-if='pointTypes === "3"'>
        <span style="display:inline-block;width:5px;height:15px;background:blue;margin-right:5px;"></span>
        <span
          class="top"
          style="display:inline-block;font-weight: bold; font-size: 14px;"
        ...
        <div>
          ...
          >
           ...
           <div class="bottom">
            <el-carousel height="250px" style="width:60%;margin:auto" v-if="hqbzMTXX && hqbzMTXX.length > 0">
    ...
    >
      <!-- 战场环境信息 -->
      <div class="box-show" v-if="pointTypes==='4'">
        <span style="display:inline-block;width:5px;height:15px;background:blue;margin-right:5px;"></span>
        <span
          class="top"
          style="display:inline-block;font-weight: bold; font-size: 14px;"
      ...
      <!-- 媒体信息 -->
        <div>
          ...
          <el-carousel height="250px" style="width:60%;margin:auto" v-if="zchjMtxx && zchjMtxx.length > 0">
    ...
    <div v-if = 'dialogThemeVisibles' style="position: absolute;width: 362px;z-index: 999;right: 30px;bottom: 127px;background: rgba(255,255,255,0.5);scrollbar-width:thin;">
      <el-tree
        ref="myTree"
        style="height:335px;overflow:scroll;overflow-x:hidden;background: rgba(255, 255, 255, 0.5);color: #000;scrollbar-width:thin;"
        :data="treeData"
        class="filter-tree"
        highlight-current
        :props="treeProps"
      ...
      <div style="display: flex;flex-wrap: wrap;height: 125px;overflow: hidden scroll;background: rgba(255, 255, 255, 0.5);scrollbar-width:thin;">
        <div v-for="(item, index) in JBData" style="text-align:center;margin: 10px;">
          <p style="width:84px;height:51px">
            <img @click= 'mouseClick(item)' style="width:56px;height:51px" :src="'/jbdz'+item.path" />
          </p>
...
import './dialogDrag'
export default {
  components: { Container, MapOl, Cesium },
  data() {
    return {
      hqbzMTXX:[],
      zchjMtxx:[],
      ...
      HQBZmsxxData:[],
      hqbzValue:'',
      mapTools: ['Home', 'MeasureLine', 'Clear'],
      JBData:[],
      treeProps: {
        label: 'label',
        children: 'children'
  ...
  methods: {
    ...
    changeMap(){
      if(this.firstMap){
        ...
        this.$refs.MapOl.$el.style = "position:absolute;left:9999px"
        this.$refs.Cesium.$el.style = "position:absolute;left:0px"
        console.log(this.$refs.mapB.$el.innerText)
        this.$refs.mapB.$el.innerText = '切换2D'
        this.$refs.leftContainer.style="display:none"
        this.$refs.jbContainer.$el.style="display:none"
        // 空情实时数据
        this.getQueryRealTimeAir()
        // 北斗实时数据
        this.getQueryRealTimeBd()
        ...
        this.$refs.MapOl.$el.style = "position:absolute;left:0px"
        this.$refs.Cesium.$el.style = "position:absolute;left:9999px"
        this.$refs.leftContainer.style="display:block"
        this.$refs.mapB.$el.innerText = '切换3D'
        this.$refs.jbContainer.$el.style="display:block"
         ...
         this.loading2 = false
          if(data){
            if(data.length && data.length>0) {
              ...
              //console.log(YYData,YKData,XZData)
        ...
        if(String(code)==='200'){
          const HQ = []
            data.forEach((item)=>{
              // 清除三维地图的标记
              if(this.firstMap){
                this.$refs.Cesium.removePoint(item.batchNumber+'hq')
              }else { // 添加三维地图的标记
                this.$refs.Cesium.addPoint(item.batchNumber+'hq',item.longitude, item.latitude, item, surfaceImage)
              }
              HQ.push(item)
            })
          //添加点及图层
      ...
      API.getQueryRealTimeBd().then(res=>{
        ...
        if(data){
          ...
          for(var i=0;i<data.length;i++){
            // 清除三维地图的标记
            if(this.firstMap){
              this.$refs.Cesium.removePoint(data[i].targetId+'bd')
            }else { // 添加三维地图的标记
              this.$refs.Cesium.addPoint(data[i].targetId+'bd',data[i].longitude, data[i].latitude,data[i],armyImage)
            }
            BD.push(data[i])
          }
          //添加点及图层
      ...
      API.getQueryRealTimeAir().then(res=>{
        ...
        if(String(code)==='200'){
          ...
          data.forEach((item)=>{
            // 清除三维地图的标记
            if(this.firstMap){
              this.$refs.Cesium.removePoint(item.batchNumber+'kq')
            }else { // 添加三维地图的标记
              this.$refs.Cesium.addPoint(item.batchNumber+'kq',item.longitude, item.latitude,item,airplaneImage)
            }
            KQ.push(item)
          })
